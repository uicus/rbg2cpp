...
int main(int argc, const char** argv){
    if(argc < 2){
        ...
        std::cerr<<"\"-fmod-split\" - turn on generation of semimoves getters based on modifiers placement (may decrease performance of generated code)"<<std::endl;
        std::cerr<<"\"-fcustom-split\" - turn on generation of semimoves getters based on noop ('.') placement (may decrease performance of generated code)"<<std::endl;
